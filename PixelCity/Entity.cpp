...
static void do_compile ()
{
  ...
  //sorted = true;
	...
	glReportError("do_compile Render list 1");
	...
	glReportError("do_compile Render list 2");
	...
	glReportError("do_compile Render list 3");
	...
	glReportError("do_compile Render list 4");
